...
class RemoteInventoryService {
  static const String baseUrl =
      'http://192.168.110.147/sumatra_api/get_inventory.php';
  ...
  Future<bool> deleteInventory(int inventoryId) async {
    final url = Uri.parse(
      'http://192.168.110.147/sumatra_api/delete_inventory.php',
    );
  ...
  Future<bool> updateInventory(Map<String, dynamic> data) async {
    final url = Uri.parse(
      'http://192.168.110.147/sumatra_api/update_inventory.php',
    );
