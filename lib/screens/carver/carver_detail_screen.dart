...
class _CarverDetailScreenState extends State<CarverDetailScreen> {
    ...
    try {
      ...
      setState(() {
        ...
        _carverChecklist = List<String>.from(
          refreshedOrder.ordersCarvingWorkChecklist,
        );
      });
    } catch (e) {
  ...
  Future<void> _startCarving() async {
    ...
    try {
      ...
      final Map<String, dynamic> updateFields = {
        'ordersWorkflowStatus': OrderWorkflowStatus.carving,
        'ordersCarvingAccountId': currentUserId,
      };
      ...
      final updatedOrder = _order.copyWith(
        ...
        ordersCarvingAccountId: updateFields['ordersCarvingAccountId'],
      ...
      print(
        'DEBUG: updatedOrder.ordersCarvingAccountId = ${updatedOrder.ordersCarvingAccountId}',
      );
      ...
      if (result == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Pesanan masuk tahap Carving')),
        );
        // Refresh layar
  ...
  Future<void> _updateChecklist() async {
    ...
    try {
      ...
      setState(() {
        _order = updatedOrder;
        _carverChecklist = List<String>.from(
          updatedOrder.ordersCarvingWorkChecklist,
        );
      });
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _submitToDiamondSetter() async {
    setState(() => _isProcessing = true);
    try {
      final updatedOrder = _order.copyWith(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Pesanan dikirim ke Diamond Setter!')),
      );
      Navigator.of(context).pop(true);
    } finally {
      setState(() => _isProcessing = false);
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.fromTab == 'onprogress') ...[
                    ...
                    // Untuk tab lain, tampilkan hanya checklist carver
                    _buildChecklistWithAccount(
                      context,
                      'Carver',
                      carverTasks,
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: _isProcessing ? null : _startCarving,
                  ),
                ),
              ),
                  ...
                  if (_carverChecklist.length == carverTasks.length &&
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: const Text(
                          'Submit ke Diamond Setter',
                          style: TextStyle(fontSize: 18),
                        ),
                        onPressed:
                            _isProcessing ? null : _submitToDiamondSetter,
                      ),
                    ),
                ],
              ),
