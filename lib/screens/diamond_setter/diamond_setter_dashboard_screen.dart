...
import 'diamond_setter_detail_screen.dart'; // Pastikan file ini ada
// Ganti import detail screen ke diamond_setter_detail_screen.dart jika sudah ada
...
class _DiamondSetterDashboardScreenState extends State<DiamondSetterDashboardScreen> {
  ...
  // Status list untuk tab khusus diamond setter
  ...
  List<Order> get _filteredOrders {
    ...
    if (_searchQuery.isNotEmpty) {
      filtered = filtered.where((order) =>
        ...
        order.jewelryType.toLowerCase().contains(_searchQuery.toLowerCase())
      ).toList();
    }
    return filtered;
  }
                                                  ...
                                                  ElevatedButton.icon(
                                                    ...
                                                    onPressed: () async {
                                                      await Navigator.of(context).push(
                                                        MaterialPageRoute(
                                                          builder: (_) => DiamondSetterDetailScreen(orderId: order.id),
                                                        ),
                                                      );
