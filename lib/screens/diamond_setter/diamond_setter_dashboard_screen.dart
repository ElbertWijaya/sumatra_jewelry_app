...
class _DiamondSetterDashboardScreenState extends State<DiamondSetterDashboardScreen> {
  ...
  // Statuses khusus Diamond Setter
                                        ...
                                        child: ListTile(
                                          ...
                                          subtitle: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                ...
                                                style: TextStyle(
                                                  color: order.workflowStatus == OrderWorkflowStatus.waitingDiamondSetting
                                                      ? Colors.orange
                                                      : order.workflowStatus == OrderWorkflowStatus.stoneSetting
                                                          ? Colors.blue
                                                          : Colors.green,
                                                ),
                                              ),
                                          ...
                                          onTap: () async {
                                            final result = await Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) => DiamondSetterDetailScreen(order: order),
                                              ),
                                            );
                                            if (result == true) {
                                              _fetchOrders();
