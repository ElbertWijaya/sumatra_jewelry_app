...
class _SalesDashboardScreenState extends State<SalesDashboardScreen> {
  ...
  Object? _selectedStatusFilter; // <--- PERUBAHAN UTAMA DI SINI
  ...
  List<Order> get _filteredOrders {
    ...
    if (_selectedStatusFilter == null) {
      ...
      filtered = filtered
          ...
          .toList();
    } else if (_selectedStatusFilter == 'onProgress') { // <--- LOGIKA FILTER UNTUK 'ON PROGRESS'
  ...
  Widget _buildStatusFilterButton(
      String label, Object? filterValue, Color color) { // <--- PERUBAHAN TIPE filterValue
    int count;
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            _buildStatusFilterButton('On Progress', 'onProgress', Colors.blue), // <--- INI PERUBAHANNYA PADA TOMBOL
                                      ...
                                      subtitle: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: TextStyle(
                                              color: order.status == OrderStatus.pending ? Colors.orange // Menunggu (Pending)
                                                   : order.status == OrderStatus.completed ? Colors.green // Selesai (Completed)
                                                   : order.status == OrderStatus.canceled ? Colors.red // Dibatalkan (Canceled)
                                                   : Colors.blue, // Untuk semua status 'In Progress' lainnya
                                            ),
                                          ), // Status
                                        ],
                                      ),
