...
class _SalesDetailScreenState extends State<SalesDetailScreen> {
  ...
  Future<void> _saveEdit() async {
    ...
    final updatedOrder = _order.copyWith(
      ...
      stoneSize: _stoneSizeController.text.isEmpty ? null : _stoneSizeController.text,
      ringSize: _ringSizeController.text.isEmpty ? null : _ringSizeController.text,
    ...
    try {
      ...
      setState(() {
        ...
        _jewelryType = updatedOrder.jewelryType.isNotEmpty ? updatedOrder.jewelryType : null;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            onChanged: _isEditing ? (val) => setState(() => _jewelryType = val) : null,
                          ),
                          DropdownButtonFormField<String>(
                            value: _goldColor,
                            decoration: const InputDecoration(
                            ...
                            items: goldColors
                                ...
                                .toList(),
                            onChanged: _isEditing ? (val) => setState(() => _goldColor = val) : null,
                          ),
                          DropdownButtonFormField<String>(
                            value: _goldType,
                            decoration: const InputDecoration(
                            ...
                            items: goldTypes
                                ...
                                .toList(),
                            onChanged: _isEditing ? (val) => setState(() => _goldType = val) : null,
                          ),
                          DropdownButtonFormField<String>(
                            value: _stoneType,
                            decoration: const InputDecoration(
                            ...
                            items: stoneTypes
                                ...
                                .toList(),
                            onChanged: _isEditing ? (val) => setState(() => _stoneType = val) : null,
                          ),
                          TextFormField(
