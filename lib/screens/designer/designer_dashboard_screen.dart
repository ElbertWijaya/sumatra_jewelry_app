...
class _DesignerDashboardScreenState extends State<DesignerDashboardScreen> {
  ...
  String _searchQuery = '';
  String _selectedTab = 'working'; // default tab 
  ...
  List<Order> get _filteredOrders {
    ...
    } else if (_selectedTab == 'on progress') {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      _buildTabButton('Waiting', 'waiting', Colors.blueGrey),
                      _buildTabButton('Working', 'working', Colors.orange),
